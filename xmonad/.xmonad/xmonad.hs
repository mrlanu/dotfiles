...
myKeys c =
  ...
  , ("M-p e", addName "Edit config files"      $ spawn "lanu-confedit")
  ...
  , ("M-p w", addName "Wi-fi"                  $ spawn "lanu-wifi")
  ...
  , ("M-M1-<Space>", addName "Toggle noborders/full" $ sendMessage (MT.Toggle NBFULL) >> sendMessage ToggleStruts)]
...
-- Multimedia Keys
  ...
  , ("<XF86MonBrightnessUp>", addName "Brightness up"    $ spawn "lux -a 10%")
  , ("<XF86MonBrightnessDown>", addName "Brightness down"    $ spawn "lux -s 10%")
  ...
  , ("C-<Print>", addName "Take screenshot of selected window" $ spawn "sleep 0.2; scrot -s") 
  , ("<Print>", addName "Take screenshot (dmscripts)" $ spawn "scrot")
  ]
